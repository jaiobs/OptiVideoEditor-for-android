...
import com.obs.videoeditor.OptiTrimmerActivity
import com.obs.videoeditor.utils.OptiSessionManager
import com.obs.videoeditor.adapter.OptiVideoOptionsAdapter
import com.obs.videoeditor.interfaces.OptiFFMpegCallback
import com.obs.videoeditor.interfaces.OptiVideoOptionListener
import com.obs.videoeditor.utils.OptiUtils
import com.obs.videoeditor.utils.VideoUtils
import com.obs.videoeditor.utils.VideoFrom
import java.io.File
    ...
    private fun initView(rootView: View?) {
        ...
        tvSave?.setOnClickListener {
            AlertDialog.Builder(context!!)
                ...
                .setMessage("Would you like to save your edited video?")
                .setPositiveButton("Continue") { dialog, which ->
                    if (masterVideoFile != null) {
                        val outputFile = createSaveVideoFile()
                        OptiCommonMethods.copyFile(masterVideoFile, outputFile)
                        Toast.makeText(context, "Your video was successfully saved", Toast.LENGTH_SHORT).show()
